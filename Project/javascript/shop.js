...
if (localStorage.getItem("Shop - Costume") === null && localStorage.getItem("Shop - Decoration") === null && localStorage.getItem("Shop - Toy") === null ) {
...
window.addEventListener("load", () => {
  ...
  costumeFromLS.forEach((costume) => {
    document.querySelector("ul#big-row-costume").insertAdjacentHTML("beforeend", 
    `
            <li class="product">
  ...
  decorationFromLS.forEach((decoration) => {
    document.querySelector("ul#big-row-decoration").insertAdjacentHTML("beforeend", 
    `
            <li class="product">
              <div class="product-img-cover">
                <img
  ...
  toyFromLS.forEach((toy) => {
    document.querySelector("ul#big-row-toy").insertAdjacentHTML("beforeend", 
    `
            <li class="product">
              <div class="product-img-cover">
                <img
